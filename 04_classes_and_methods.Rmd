...
The arguments of new method should be a superset of the arguments of the generic
...
```
3. Write a summary method for your "ols" class that uses `NextMethod()` to compute the usual "lm" summary, but return an object of class "summary.ols". Write a print method for the `"summary.ols"` class to return output of the form
